...
<!-- TODO: 上架后补充截图，建议 3-5 张：解锁页 / 主列表 / 分类选择 / 密码生成器 / 备份页 -->
...
MySecret 是**完全免费且开源**的，没有任何广告或变现。如果它对你有帮助，欢迎请我喝杯咖啡 ☕

<!-- 注册好捐赠渠道后，替换下面的占位符 -->

| 渠道 | 链接 |
|------|------|
| ☕ Buy Me a Coffee | `TODO: 填入 https://www.buymeacoffee.com/你的用户名` |
| 💛 爱发电（国内） | `TODO: 填入 https://afdian.com/a/你的用户名` |
